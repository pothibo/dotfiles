...
hi User1            ctermbg=gray        ctermfg=darkyellow
hi User2            ctermbg=gray        ctermfg=white
hi User3            ctermbg=gray        ctermfg=white
hi User4            ctermbg=gray        ctermfg=57
hi User5            ctermbg=gray        ctermfg=white
hi User6            ctermbg=1           ctermfg=white
hi User7            ctermbg=166         ctermfg=white
...
hi WarningMsg       ctermfg=darkyellow ctermbg=gray          cterm=NONE
